...
public class Urls {
    ...
    public static final String URL_login = "http://testapi.china-madpay.com:85/crmapi_v4/loginCheck";
    ...
    public static final String getHome = "http://testapi.china-madpay.com:85/crmapi_v4/core/funcs/main/getHomePageData";
}
