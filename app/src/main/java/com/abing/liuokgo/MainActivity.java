...
import com.abing.liuokgo.base.BaseRecyclerAdapter;
import com.abing.liuokgo.okgo.FileDownloadActivity;
import com.abing.liuokgo.okgo.FormUploadActivity;
import com.abing.liuokgo.okgo.JsonRequestActivity;
import com.abing.liuokgo.okgo.OkHttpActivity;
...
//            if (position == 1) startActivity(new Intent(MainActivity.this, RxActivity.class));
            ...
            if (position == 5) startActivity(new Intent(MainActivity.this, LTextActivity.class));
